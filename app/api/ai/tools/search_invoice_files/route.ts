// app/api/ai/tools/search_invoice_files/route.ts
...
export async function POST(req: Request) {
  try {
    ...
    const { company, unit, vin, plate, invoice, dateRange, limit = 15, context } = body
    
    console.log('=== SEARCH INVOICE FILES ===')
    console.log('Search params:', { company, unit, vin, plate, invoice, dateRange, limit })
    ...
    const response: SearchResponse = {
      ...
      metadata: {
        searchParams: { company, unit, vin, plate, invoice, dateRange, limit },
